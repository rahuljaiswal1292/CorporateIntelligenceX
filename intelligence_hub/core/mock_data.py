...
4. **Hospitality**: Owner and operator of Address Hotels + Resorts and Vida Hotels and Resorts."""
        ...
        socials = {"LinkedIn": "https://linkedin.com/company/emaar", "Twitter": "@emaar", "Instagram": "@emaardubai"}
        
        shareholders = [
            {"Name": "Public / Free Float", "Type": "Public", "%": "60.0%"},
            {"Name": "Investment Corp of Dubai (ICD)", "Type": "Government", "%": "24.0%"},
...
4. **DenizBank**: Significant subsidiary operating in Turkey."""
        ...
        socials = {"LinkedIn": "https://linkedin.com/company/emirates-nbd", "Twitter": "@EmiratesNBD", "Instagram": "@emiratesnbd_ae"}

        shareholders = [
            {"Name": "Investment Corp of Dubai (ICD)", "Type": "Government", "%": "55.75%"},
...
- Joint ventures establishing new national carriers (e.g., Fly Arna, Fly Jinnah)."""
        ...
        socials = {"LinkedIn": "https://linkedin.com/company/air-arabia", "Twitter": "@airarabia", "Instagram": "@airarabiagroup"}
...
4. **e& capital**: Investment arm for startup acquisitions."""
        ...
        socials = {"LinkedIn": "https://linkedin.com/company/eand", "Twitter": "@eand", "Instagram": "@eandgroup"}

        shareholders = [
            {"Name": "Emirates Investment Authority", "Type": "Government", "%": "60.0%"},
...
FAB offers corporate, investment, and personal banking solutions, with a strong presence in global markets."""
    ...
    if ticker == "EMAAR":
        data["financials"] = {
            "current": {"period": "TTM Q3 2024", "rev": "AED 26.7B", "profit": "AED 11.6B", "price": "AED 8.45", "trend": "+1.2%"},
            "last_year": {"period": "FY 2023", "rev": "AED 26.0B", "profit": "AED 10.8B"},
            "last_quarter": {"period": "Q3 2024", "rev": "AED 6.8B", "profit": "AED 2.9B", "rev_gro": "+3%", "prof_gro": "+8%"}
        }
        data["risk"] = {"debt_equity": "0.6x", "credit_rating": "BBB- (S&P)", "interest_cover": "8.4x"}
        data["competitors"] = [
            {"Company": "Emaar Dev", "Mkt Cap": "AED 28B", "P/E": "8.5", "Rev Growth": "12%"},
            {"Company": "Aldar", "Mkt Cap": "AED 45B", "P/E": "14.2", "Rev Growth": "8%"},
            {"Company": "Damac", "Mkt Cap": "Private", "P/E": "N/A", "Rev Growth": "5%"},
            {"Company": "Deyaar", "Mkt Cap": "AED 3.8B", "P/E": "9.1", "Rev Growth": "6.5%"},
            {"Company": "Union Prop", "Mkt Cap": "AED 1.5B", "P/E": "N/A", "Rev Growth": "-2%"}
        ]
        data["sources"] = [
            {"title": "Emaar Q3 2024 Earnings Release", "url": "https://www.emaar.com/investor-relations/financials"},
            {"title": "Emaar FY 2023 Integrated Report", "url": "https://www.emaar.com/annual-reports/2023"},
            {"title": "DFM Market Disclosure - The Heights Launch", "url": "https://www.dfm.ae/issuers/emaar"}
        ]
        data["insights"] = [
            {
        ...
        data["financials"] = {
            "current": {"period": "FY 2024", "rev": "AED 43.0B", "profit": "AED 21.5B", "price": "AED 17.50", "trend": "+0.5%"},
            "last_year": {"period": "FY 2023", "rev": "AED 39.5B", "profit": "AED 18.0B"},
            "last_quarter": {"period": "Q4 2024", "rev": "AED 11.2B", "profit": "AED 5.3B", "rev_gro": "+8%", "prof_gro": "+12%"}
        }
        data["risk"] = {"debt_equity": "N/A (Bank)", "credit_rating": "A+ (Fitch)", "interest_cover": "N/A"}
        data["competitors"] = [
            {"Company": "FAB", "Mkt Cap": "AED 180B", "P/E": "12.5", "Rev Growth": "4%"},
            {"Company": "ADCB", "Mkt Cap": "AED 65B", "P/E": "10.2", "Rev Growth": "6%"},
            {"Company": "DIB", "Mkt Cap": "AED 42B", "P/E": "8.9", "Rev Growth": "7%"},
            {"Company": "Mashreq", "Mkt Cap": "AED 38B", "P/E": "9.5", "Rev Growth": "15%"},
            {"Company": "RAKBANK", "Mkt Cap": "AED 9B", "P/E": "8.1", "Rev Growth": "5%"}
        ]
        data["sources"] = [
            {"title": "Emirates NBD FY 2024 Results Presentation", "url": "https://www.emiratesnbd.com/en/investor-relations"},
            {"title": "Basel III Pillar 3 Disclosure", "url": "https://www.centralbank.ae/en/regulations"}
        ]
        data["insights"] = [
            {
                "category": "Lending & Refinancing Accuracy",
        ...
        data["financials"] = {
            ...
            "last_quarter": {"period": "Q3 2024", "rev": "AED 13.1B", "profit": "AED 2.5B", "rev_gro": "+2%", "prof_gro": "+4%"}
        }
        data["risk"] = {"debt_equity": "1.1x", "credit_rating": "AA- (S&P)", "interest_cover": "12.5x"}
        data["competitors"] = [
            {"Company": "Du (EITC)", "Mkt Cap": "AED 24B", "P/E": "14.5", "Rev Growth": "5.1%"},
            {"Company": "Ooredoo", "Mkt Cap": "QAR 28B", "P/E": "12.1", "Rev Growth": "2.8%"},
            {"Company": "Vodafone", "Mkt Cap": "GBP 19B", "P/E": "11.2", "Rev Growth": "1.4%"},
            {"Company": "STC", "Mkt Cap": "SAR 200B", "P/E": "16.5", "Rev Growth": "6%"},
            {"Company": "Zain Group", "Mkt Cap": "KWD 2.5B", "P/E": "10.8", "Rev Growth": "2%"}
        ]
        data["sources"] = [
             {"title": "e& Q3 2024 Financial Report", "url": "https://www.eand.com/investors"},
    ...
    base_price = float(data["financials"]["current"]["price"].split(" ")[1])
    volatility = base_price * 0.02
    
    open_data = [base_price + random.uniform(-volatility, volatility) for _ in range(100)]
    close_data = [o + random.uniform(-volatility/2, volatility/2) for o in open_data]
    high_data = [max(o, c) + random.uniform(0, volatility/3) for o, c in zip(open_data, close_data)]
    low_data = [min(o, c) - random.uniform(0, volatility/3) for o, c in zip(open_data, close_data)]
