...
class WikiScraper:
    ...
    def scrape_profile(self, company_name: str) -> dict:
        ...
        variations = [
            ...
            clean_name.replace(" ", "_") + "_(insurance)" # Specific for Sukoon/Insurance cases
        ]
        ...
        for variant in variations:
            ...
            if html and "Wikipedia does not have an article with this exact name" not in html:
                used_url = url
                break
        
        if not html or "Wikipedia does not have an article with this exact name" in html:
