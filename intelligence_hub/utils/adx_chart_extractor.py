...
class ADXChartExtractor:
    ...
    async def _handle_response(self, response: Response):
        ...
        try:
            ...
            # Skip noise
            if any(ext in url for ext in [".css", ".png", ".jpg", ".js", "google-analytics", "sprinklr"]):
                return
    ...
    def _normalize_tv_data(self, data: dict):
        ...
        try:
            ...
            if not times or not opens: return
...
if __name__ == "__main__":
    ...
    async def run_batch():
        ...
        total = len(tickers)
        logger.info(f"Starting batch extraction for {total} tickers: {', '.join(tickers)}")
        logger.info("="*80)
