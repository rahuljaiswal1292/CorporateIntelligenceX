...
class DFMStockExtractor:
    ...
    def __init__(self):
        self.download_manager = DFMDownloadManager()
    ...
    async def extract(self, ticker: str):
        ...
        if DATA_DIR:
             target_dir = os.path.join(DATA_DIR, "dfm", ticker, "daily_summary", "structured")
        else:
             target_dir = os.path.join("data", "dfm", ticker, "daily_summary", "structured")
        ...
        async with async_playwright() as p:
            ...
            browser = await p.chromium.launch(
                headless=False, # Often better for DFM to avoid bot detection
                args=[
            ...
            try:
                ...
                try:
                    ...
                    logger.warning("Download button not found immediately. Waiting longer...")
